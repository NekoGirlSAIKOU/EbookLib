...
data class Catalog(val title:String, var sub_catalog:MutableList<Catalog>?=null){
    ...
    constructor(epubHtml: EpubHtml,sub_catalog:MutableList<Catalog>?):this(epubHtml.title ?:"Untitled",sub_catalog){
    ...
    constructor(title:String,id:String,path:String,sub_catalog: MutableList<Catalog>?):this(title,sub_catalog){
        this.id = id
        this.path = path
    }
